...
inline std::monostate syscall_chown(SS x667, immer::flex_vector<PtrVal> x668, Cont x669) {
FS x670 = x667.get_fs();
...
inline std::monostate syscall_chmod(SS x613, immer::flex_vector<PtrVal> x614, Cont x615) {
FS x616 = x613.get_fs();
...
inline std::monostate syscall_unlink(SS x567, immer::flex_vector<PtrVal> x568, Cont x569) {
FS x570 = x567.get_fs();
...
inline std::monostate syscall_creat(SS x502, immer::flex_vector<PtrVal> x503, Cont x504) {
FS x505 = x502.get_fs();
...
inline std::monostate syscall_rmdir(SS x437, immer::flex_vector<PtrVal> x438, Cont x439) {
FS x440 = x437.get_fs();
...
inline std::monostate syscall_mkdir(SS x372, immer::flex_vector<PtrVal> x373, Cont x374) {
FS x375 = x372.get_fs();
...
inline std::monostate syscall_stat(SS x301, immer::flex_vector<PtrVal> x302, Cont x303) {
FS x304 = x301.get_fs();
...
inline std::monostate syscall_lseek(SS x248, immer::flex_vector<PtrVal> x249, Cont x250) {
FS x251 = x248.get_fs();
...
inline std::monostate syscall_write(SS x195, immer::flex_vector<PtrVal> x196, Cont x197) {
FS x198 = x195.get_fs();
...
inline std::monostate syscall_read(SS x150, immer::flex_vector<PtrVal> x151, Cont x152) {
FS x153 = x150.get_fs();
...
inline std::monostate syscall_close(SS x95, immer::flex_vector<PtrVal> x96, Cont x97) {
FS x98 = x95.get_fs();
PtrVal x99 = x96.at(0);
...
inline std::monostate syscall_open(SS x29, immer::flex_vector<PtrVal> x30, Cont x31) {
FS x32 = x29.get_fs();
PtrVal x33 = x30.at(0);
/* getFile */;
