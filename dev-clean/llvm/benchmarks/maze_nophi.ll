...
; <label>:91:                                     ; preds = %81
  ...
  br i1 %93, label %94, label %._crit_edge3
...
; <label>:94:                                     ; preds = %91
  ...
  br i1 %96, label %._crit_edge4, label %._crit_edge5

._crit_edge5:                                     ; preds = %94
  br label %97

._crit_edge4:                                     ; preds = %94
  br label %100

; <label>:97:                                     ; preds = %._crit_edge5, %._crit_edge3, %._crit_edge2, %._crit_edge1
...
; <label>:100:                                    ; preds = %._crit_edge4, %._crit_edge, %97
  ...
  br i1 %112, label %113, label %117 ;._crit_edge6
...
.117:                                    ; preds = %._crit_edge6, %113
  ; %118 = phi i1 [ false, %._crit_edge6 ], [ %116, %113 ] ;; Changed here
  %119 = zext i1 %113 to i64
  %120 = select i1 %113, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.12, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.13, i32 0, i32 0)
  %121 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.11, i32 0, i32 0), i32 %104, i32 %109, i8* %120)
  %122 = load i32, i32* %8, align 4
  %123 = load i32, i32* %6, align 4
  %124 = icmp eq i32 %122, %123
  br i1 %124, label %125, label %._crit_edge7
...
; <label>:125:                                    ; preds = %117
  ...
  br i1 %128, label %129, label %._crit_edge8

._crit_edge8:                                     ; preds = %125
  br label %131
...
; <label>:131:                                    ; preds = %._crit_edge8, %._crit_edge7
