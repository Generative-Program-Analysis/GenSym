; ModuleID = 'multi_path_1048576_sym.c'
source_filename = "multi_path_1048576_sym.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @f(i32 %x0, i32 %x1, i32 %x2, i32 %x3, i32 %x4, i32 %x5, i32 %x6, i32 %x7, i32 %x8, i32 %x9, i32 %x10, i32 %x11, i32 %x12, i32 %x13, i32 %x14, i32 %x15, i32 %x16, i32 %x17, i32 %x18, i32 %x19) #0 {
entry:
  ...
  store i32 %x17, i32* %x17.addr, align 4
  store i32 %x18, i32* %x18.addr, align 4
  store i32 %x19, i32* %x19.addr, align 4
  %0 = load i32, i32* %x0.addr, align 4
  %cmp = icmp sgt i32 %0, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %1 = load i32, i32* %x19.addr, align 4
  %2 = load i32, i32* %x10.addr, align 4
  %add = add nsw i32 %1, %2
  %add1 = add nsw i32 %add, 60
...
if.then3:                                         ; preds = %if.end
  %4 = load i32, i32* %x19.addr, align 4
  %5 = load i32, i32* %x9.addr, align 4
  %add4 = add nsw i32 %4, %5
  %add5 = add nsw i32 %add4, 65
...
if.then8:                                         ; preds = %if.end6
  %7 = load i32, i32* %x17.addr, align 4
  %8 = load i32, i32* %x15.addr, align 4
...
if.then13:                                        ; preds = %if.end11
  %10 = load i32, i32* %x10.addr, align 4
  %11 = load i32, i32* %x9.addr, align 4
  %add14 = add nsw i32 %10, %11
  %add15 = add nsw i32 %add14, 15
...
if.then18:                                        ; preds = %if.end16
  %13 = load i32, i32* %x16.addr, align 4
  %14 = load i32, i32* %x17.addr, align 4
...
if.then23:                                        ; preds = %if.end21
  %16 = load i32, i32* %x8.addr, align 4
  %17 = load i32, i32* %x14.addr, align 4
  %add24 = add nsw i32 %16, %17
  %add25 = add nsw i32 %add24, 17
...
if.then28:                                        ; preds = %if.end26
  ...
  %20 = load i32, i32* %x8.addr, align 4
...
if.then33:                                        ; preds = %if.end31
  %22 = load i32, i32* %x13.addr, align 4
  %23 = load i32, i32* %x14.addr, align 4
  %add34 = add nsw i32 %22, %23
  %add35 = add nsw i32 %add34, 73
...
if.then38:                                        ; preds = %if.end36
  %25 = load i32, i32* %x7.addr, align 4
  %26 = load i32, i32* %x9.addr, align 4
  %add39 = add nsw i32 %25, %26
  %add40 = add nsw i32 %add39, 36
...
if.then43:                                        ; preds = %if.end41
  %28 = load i32, i32* %x10.addr, align 4
  %29 = load i32, i32* %x9.addr, align 4
  %add44 = add nsw i32 %28, %29
  %add45 = add nsw i32 %add44, 86
...
if.then48:                                        ; preds = %if.end46
  %31 = load i32, i32* %x17.addr, align 4
  %32 = load i32, i32* %x1.addr, align 4
  %add49 = add nsw i32 %31, %32
  %add50 = add nsw i32 %add49, 11
...
if.then53:                                        ; preds = %if.end51
  %34 = load i32, i32* %x12.addr, align 4
  %35 = load i32, i32* %x0.addr, align 4
  %add54 = add nsw i32 %34, %35
  %add55 = add nsw i32 %add54, 55
...
if.then58:                                        ; preds = %if.end56
  %37 = load i32, i32* %x11.addr, align 4
  %38 = load i32, i32* %x8.addr, align 4
  %add59 = add nsw i32 %37, %38
  %add60 = add nsw i32 %add59, 39
...
if.then63:                                        ; preds = %if.end61
  %40 = load i32, i32* %x16.addr, align 4
  %41 = load i32, i32* %x17.addr, align 4
  %add64 = add nsw i32 %40, %41
  %add65 = add nsw i32 %add64, 58
...
if.then68:                                        ; preds = %if.end66
  %43 = load i32, i32* %x6.addr, align 4
  %44 = load i32, i32* %x4.addr, align 4
  %add69 = add nsw i32 %43, %44
  %add70 = add nsw i32 %add69, 77
...
if.then73:                                        ; preds = %if.end71
  %46 = load i32, i32* %x8.addr, align 4
  %47 = load i32, i32* %x7.addr, align 4
  %add74 = add nsw i32 %46, %47
  %add75 = add nsw i32 %add74, 72
  store i32 %add75, i32* %x15.addr, align 4
  br label %if.end76

if.end76:                                         ; preds = %if.then73, %if.end71
  %48 = load i32, i32* %x16.addr, align 4
  %cmp77 = icmp sgt i32 %48, 16
  br i1 %cmp77, label %if.then78, label %if.end81

if.then78:                                        ; preds = %if.end76
  %49 = load i32, i32* %x5.addr, align 4
  %50 = load i32, i32* %x8.addr, align 4
  %add79 = add nsw i32 %49, %50
  %add80 = add nsw i32 %add79, 10
  store i32 %add80, i32* %x16.addr, align 4
  br label %if.end81

if.end81:                                         ; preds = %if.then78, %if.end76
  %51 = load i32, i32* %x17.addr, align 4
  %cmp82 = icmp sgt i32 %51, 17
  br i1 %cmp82, label %if.then83, label %if.end86

if.then83:                                        ; preds = %if.end81
  %52 = load i32, i32* %x8.addr, align 4
  %53 = load i32, i32* %x6.addr, align 4
  %add84 = add nsw i32 %52, %53
  %add85 = add nsw i32 %add84, 90
  store i32 %add85, i32* %x17.addr, align 4
  br label %if.end86

if.end86:                                         ; preds = %if.then83, %if.end81
  %54 = load i32, i32* %x18.addr, align 4
  %cmp87 = icmp sgt i32 %54, 18
  br i1 %cmp87, label %if.then88, label %if.end91

if.then88:                                        ; preds = %if.end86
  %55 = load i32, i32* %x17.addr, align 4
  %56 = load i32, i32* %x4.addr, align 4
  %add89 = add nsw i32 %55, %56
  %add90 = add nsw i32 %add89, 46
  store i32 %add90, i32* %x18.addr, align 4
  br label %if.end91

if.end91:                                         ; preds = %if.then88, %if.end86
  %57 = load i32, i32* %x19.addr, align 4
  %cmp92 = icmp sgt i32 %57, 19
  br i1 %cmp92, label %if.then93, label %if.end96

if.then93:                                        ; preds = %if.end91
  %58 = load i32, i32* %x19.addr, align 4
  %59 = load i32, i32* %x8.addr, align 4
  %add94 = add nsw i32 %58, %59
  %add95 = add nsw i32 %add94, 75
  store i32 %add95, i32* %x19.addr, align 4
  br label %if.end96

if.end96:                                         ; preds = %if.then93, %if.end91
  %60 = load i32, i32* %x10.addr, align 4
  %61 = load i32, i32* %x10.addr, align 4
