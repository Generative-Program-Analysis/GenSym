; ModuleID = 'multi_path_512_sym.c'
source_filename = "multi_path_512_sym.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @f(i32 %x0, i32 %x1, i32 %x2, i32 %x3, i32 %x4, i32 %x5, i32 %x6, i32 %x7, i32 %x8) #0 {
entry:
...
if.then:                                          ; preds = %entry
  %1 = load i32, i32* %x4.addr, align 4
  %2 = load i32, i32* %x4.addr, align 4
  %add = add nsw i32 %1, %2
  %add1 = add nsw i32 %add, 28
...
if.then3:                                         ; preds = %if.end
  ...
  %5 = load i32, i32* %x8.addr, align 4
  %add4 = add nsw i32 %4, %5
  %add5 = add nsw i32 %add4, 82
...
if.then8:                                         ; preds = %if.end6
  %7 = load i32, i32* %x6.addr, align 4
  %8 = load i32, i32* %x2.addr, align 4
  %add9 = add nsw i32 %7, %8
  %add10 = add nsw i32 %add9, 49
...
if.then13:                                        ; preds = %if.end11
  %10 = load i32, i32* %x6.addr, align 4
  %11 = load i32, i32* %x7.addr, align 4
  %add14 = add nsw i32 %10, %11
  %add15 = add nsw i32 %add14, 52
...
if.then18:                                        ; preds = %if.end16
  ...
  %14 = load i32, i32* %x8.addr, align 4
  %add19 = add nsw i32 %13, %14
  %add20 = add nsw i32 %add19, 48
...
if.then23:                                        ; preds = %if.end21
  ...
  %17 = load i32, i32* %x8.addr, align 4
  %add24 = add nsw i32 %16, %17
  %add25 = add nsw i32 %add24, 82
...
if.then28:                                        ; preds = %if.end26
  %19 = load i32, i32* %x6.addr, align 4
  %20 = load i32, i32* %x5.addr, align 4
  %add29 = add nsw i32 %19, %20
  %add30 = add nsw i32 %add29, 89
