        ...
        for {
          ...
          def cmpVal(val1: Value, val2: Value): Value = (val1, val2) match {
            ...
            case (SymV(v1), SymV(v2)) => pred match {
              case IPredicate("eq")  => SymV(v1 + " == " + v2)
              case IPredicate("neq")  => SymV(v1 + " != " + v2)
              case IPredicate("sle")  => SymV(v1 + " <= " + v2)
              case IPredicate("slt")  => SymV(v1 + " < " + v2)
              case IPredicate("sgt")  => SymV(v1 + " > " + v2)
              case IPredicate("sge") => SymV(v1 + " >= " + v2)
              case IPredicate("ule")  => SymV(v1 + " <= " + v2)
              case IPredicate("ult")  => SymV(v1 + " < " + v2)
              case IPredicate("ugt")  => SymV(v1 + " > " + v2)
              case IPredicate("uge")  => SymV(v1 + " >= " + v2)
            }
