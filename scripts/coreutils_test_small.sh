...
llsc_option="--output-tests-cov-new  --thread=1  --search=random-path  --solver=z3   --output-ktest --timeout=3600   --cons-indep --max-sym-array-size=4096"
...
program_arg[pathchk]="--sym-stdout  --sym-stdin 2 --sym-arg 2"
