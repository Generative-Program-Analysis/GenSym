...
import gensym.structure.freer.Coin.{Coin, Coin$, biasedCoin, coinChoice}
...
object Coin {
  import gensym.structure.freer.Nondet.{Choice$, Fail$, Nondet, fail}
...
object CoinList {
  import gensym.structure.freer.NondetList._
