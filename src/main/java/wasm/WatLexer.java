...
public class WatLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"FREE", "UNREACHABLE", "DROP", "BLOCK", "LOOP", "FOR", "VBAR", "END", 
			"BR", "BR_IF", "BR_TABLE", "RETURN", "IF", "THEN", "ELSE", "SELECT", 
