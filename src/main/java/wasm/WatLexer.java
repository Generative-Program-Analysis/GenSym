...
public class WatLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"OP_ROTL", "OP_ROTR", "OP_MIN", "OP_MAX", "OP_COPYSIGN", "CONVERT", "MEMORY_SIZE", 
			"MEMORY_GROW", "MEMORY_FILL", "MEMORY_COPY", "MEMORY_INIT", "TYPE", "FUNC", 
			...
			"OUTPUT", "VAR", "V128", "SPACE", "COMMENT", "IXX", "FXX", "Symbol", 
			"Num", "HexNum", "Sign", "Digit", "HexDigit", "Letter", "Nat", "Int", 
			"Frac", "HexFrac", "Float", "String_", "Name", "Escape", "NXX", "MIXX", 
			"MFXX", "SIGN", "Char", "Ascii", "Ascii_no_nl", "Utf8Cont", "Utf8", "Utf8_no_nl", 
			"Utf8Enc"
		};
	}
