...
generate code every time when we reach a $\lambda$-term, instead of lazily
...
roadmap and focus on discussing closure representations and function
...
@in/out@ caches additionally. Inside @f@, we collapse the monadic value of
