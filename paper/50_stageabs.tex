...
Every components in the interpreter except @Expr@s are staged. The data
...
caching is used for every recursive calls in our abstract interpreter. But this
...
of the components are all dynamic. But this is not always true since the static
data has to be used somewhere with dynamic operations. Partial-static data is a
...
style, where \textit{compositional} means that every recursive calls of our abstract
