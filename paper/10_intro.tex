...
In this paper, we show how to naturally extend the first Futamura
projection to abstract interpreters. We present an
...
Similar to the two-level semantics \cite{NIELSON1989117}, we found
