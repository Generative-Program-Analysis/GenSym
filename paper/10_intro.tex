...
effort, either by mechanized proofs \cite{Darais:2016:CGC:2951913.2951934} or
...
Roughly at the same time when abstract interpretation was proposed,
\citet{futamura1971partial} observed a close
...
that runs faster. 
In recent years, the idea of Futamura projections has attracted more attentions
...
The challenge here: can we apply Futamura projections to a general abstract interpreter
...
abstract domains, and computes fixed-points iteratively over caches. 
...
model as possible.
In short, we borrow ideas and techniques from multi-stage programming and
embedded DSLs, and apply them to abstract interpreters:  1) To
...
fact are all firmly rooted in the concrete semantics.  This
