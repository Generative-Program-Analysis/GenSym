...
the program, i.e., they can be known whether statically or dynamically, then
...
argument @arg@ to an environment (as well as an accompanying heap object, if for
the interest of using assignments) that maps free variables in $e$ to some
...
produces fast code that does the analysis?}
...
over multiple abstractions, which can be later instantiated.
