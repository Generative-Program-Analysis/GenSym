...
To enable such flexibility between different semantics, we extensively use generic 
programming and abstract type members over multiple abstractions, which can be 
later instantiated.
