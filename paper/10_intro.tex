...
fact,LMS-based staging only requires type annotations, static analysis trade-off
between precision and efficiency, we argue that mp is an approach to improve the
latter one while fix the former one}
