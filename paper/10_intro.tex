...
annotations (i.e., binding-time annotations) to be explict from the programmers.
These staging annotations identify which part of the inputs should be
specialized. As a classical example, we consider the power function:
...
in its type @Rep[Int]@ -- a representation of @Int@) and @e@ is known in the
...
Some recent progress such as Abstracting Abstract Machines (AAM)
