...
\paragraph{Primitive Operations} The primitive operations are changed according to
...
The co-inductive caching algorithm is implemented as an instrumentation over
...
Similar to store updates, the cache update is also a point-wise join.
