...
operator. The trait \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{SPLattice} (Figure \ref{fig:splattice}) defines a type
class of stage polymorphic lattices. Similar to \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{MonadOps} in Section
\ref{generic_if}, we introduce an additional higher-kinded type \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{R[_]} to
annotate the binding-times, where \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{R[_]} wraps datatype \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{S} and \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{Boolean} in
these operations.
...
In this section, we simply let the binding-time type \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{R[T] = T} (i.e., \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{NoRep})
...
We first widen the concrete values to \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{AbsValue}: numbers are lifted to a
singleton object \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{IntTop} representing the set of all numbers; closures remain
the same. Then the type \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{Value} is a set of \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{AbsValue} (we abuse the type names
a bit, as the generic interface already defined the abstract type \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{Value}).
...
addresses. After defining the \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{Value} and \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{Addr} type, the environments and
stores are automatically lifted to abstract environments and abstract stores,
i.e., \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{Map[Ident, Addr]} and \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{Map[Addr, Set[AbsValue]]} respectively.
...
the algorithm in detail. A \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{Cache} is a mapping from configurations \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{Config} to
...
Second, when applying a function, for instance, \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{f(a)}, the possible lambda
terms of \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{f} is computed approximately. As a result, we may retrieve a set of
closures when dereferencing the address of \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{f} and need to apply all of them.
...
\lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{Set[M[_], A]} monad transformer, where \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{M} is the inner monad being
transformed, and \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{A} is the type of elements in the set. We use a \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{ReaderT} for
one cache that will not be changed during one fixed-point iteration, and use a
\lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{StateT} for another cache that will be constantly updated during analysis.
\citet{DBLP:journals/pacmpl/DaraisLNH17} discuss different permutation of the
monad stack for abstract interpretation. The following \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{AnsM} type shows the
...
Similar to the concrete scenario, we sketch the implementation of \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{flatMap} for
\lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{SetT} transformer and omit the rest. The value \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{run} encapsulated by the monad
is of type \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{M[SetT[A]]}, where \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{M[_]} is the inner monad, and \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{A} is the element
type of the set. The \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{flatMap} method takes a function that transforms each
element of type \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{A} from \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{M[Set[A]]} into a \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{SetT[M, B]} value, and then folds
all the transformed values into a single monadic value of type \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{Set[M, B]}.
\begin{lstlisting}
...
\lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{Value} and \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{Store}. In the abstract setting, we have a \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{SetT} inside of the
environment monad and store monad, which becomes the container type of the pair
of values and stores, i.e., \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{Set[(Value, Store)]}. Also note that the reader and
...
in \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{br0} method, we combine the results using \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{mplus} from \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{MonadPlus}, which
requires the value domains are join-semilattices (in our case \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{Set}s and
\lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{Map}s).
\begin{lstlisting}
...
\lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{CloV}, but we lift it to a singleton set domain.
\begin{lstlisting}
  def close(ev: Expr => Ans)(λ: Lam, ρ: Env): Value = Set(CloV(λ, ρ))
\end{lstlisting}

For function applications, \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{ap_clo} looks the same as the concrete interpreter.
...
\cite{DBLP:journals/pacmpl/DaraisLNH17, Wei:2018:RAA:3243631.3236800,
  Rosendahl:AbsIntPL}. The idea is to use a \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{in} cache and a \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{out} cache during
the depth-first evaluation, where the \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{in} cache stores the result from last
iteration, and \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{out} cache is used for updates in current iteration. In the next
iteration, the last \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{out} cache will be served as \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{in} cache, and an empty cache
is plugged-in to the \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{out} slot. Once the \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{out} cache does not contain anything
new than the \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{in} cache, the fixed-point is reached.

In our monad stack, the \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{in} and \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{out} cache modeled by a reader effect and
...
\lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{eval} (Figure \ref{fig:coind_cache}), and it also closes the open recursion.
Initially, the two caches are both empty.
During the iteration, we first check whether \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{out} contains the configuration
\lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{cfg}, representing the current desired computation. If it does, then the result
is directly returned through the monads.
Otherwise, we first retrieve the results from \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{in} (\lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{⊥} if not contained in
\lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{in}), and join it into the \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{out} cache.
Then we invoke \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{ev} to compute the result for this iteration, where \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{ev} takes
\lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{fix(ev)} as a self reference.
After the evaluation, the store \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{σ} may have been changed. We update the
\lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{out} cache with the new result, i.e., a pair of value and store \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{(v, σ)}.
Similar to store update, cache update is also a point-wise join.

The iteration terminates when the resulting \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{out} cache is equivalent to the
input \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{in} cache, which indicates that there is no more fact can be gained, thus
