...
result without losing precision, then we can reduce the overhead of repeatedly
...
As we have already seen from Section \ref{sai}, and recall that the primitive
...
\cite{DBLP:conf/cc/CousotC02}: such generated function is a modularly reusable
