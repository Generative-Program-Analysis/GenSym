...
primitive operation \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{close} can denote a $\lambda$ term to a next-stage Scala function.  The specializing of the staged abstract interpreter to
