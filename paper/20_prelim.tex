...
%In Section~\ref{cases_imp}, we will add more imperative features to the
language. Since we are mostly
interested in analyzing the dynamic behaviors of the program, we disguise any
...
@alloc@ simply takes the size of the current store and produce the successor number.
