...
mappings from identifiers to addressess and mappings from addresses to values,
respectively. But the @Addr@ and @Value@ are just declared as abstracrt types.
...
\paragraph{Moandic operations} We define the return type of the interpreter as
...
arugment value and then does the application.
