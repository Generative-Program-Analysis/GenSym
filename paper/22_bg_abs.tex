...
For example, here we use powersets as the abstract domain, and the unstaged lattice 
...
For branching, @branch0@ joins the answers from two branches since we are doing a path-insensitive analysis. 
