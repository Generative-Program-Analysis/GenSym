...
and SMT-based program analysis\todo{cite}, Datalog-based points-to
analysis\todo{cite}, and \todo{}. Similar to the idea in this paper, such
...
Recent work shows that the numerical abstract domains can be also specialized
