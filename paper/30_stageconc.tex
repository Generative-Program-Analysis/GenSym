...
matched \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{IRCompiledClo} and \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{IRApClo} and will generate definitions via \lstinline[keywordstyle=,flexiblecolumns=false,mathescape=false,basicstyle=\tt]{emitValDef} for them.
