...
LMS provides a type constructor @Rep[T]@, where @T@ can be an arbitrary type,
indicating a value of type @T@ will be known at the future stage.
...
The function @f@ passed to @flatMap@ is also a value known at the current stage.
