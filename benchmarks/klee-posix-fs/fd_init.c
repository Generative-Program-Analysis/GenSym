...
void klee_init_fds(unsigned n_files, unsigned file_length,
  ...
  if (__exe_fs.max_failures) {
    ...
    make_symbolic(__exe_fs.close_fail, sizeof(*__exe_fs.close_fail));
    make_symbolic(__exe_fs.ftruncate_fail, sizeof(*__exe_fs.ftruncate_fail));
    make_symbolic(__exe_fs.getcwd_fail, sizeof(*__exe_fs.getcwd_fail));
  }
