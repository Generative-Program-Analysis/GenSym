(module 
  ...
  (import "mem" "alloc" (func $mem.alloc (param i32) (result i32)))
  ...
  (import "mem" "free" (func $mem.free (param i32)))
	...
	(func $main
		...
		;; logical order: a>b>c>d>e>f>g>x>y>z>k
		(i32.const 1024)
		(call $i32.symbolic)
		(i32.const 1026)
		(call $i32.symbolic)
		...
		;; 1 symbolic variables w/o order
		;; h
		(i32.const 1038)
		(call $i32.symbolic)
		(i32.const 1024)
...
(i32.and)
	...
	(export "main" (func $main))
		(data $0 (i32.const 1024) "a\00b\00c\00d\00e\00f\00g\00h\00i\00j\00x\00y\00z\00k\00")
)
