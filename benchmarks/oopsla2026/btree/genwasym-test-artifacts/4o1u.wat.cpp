...
std::monostate x7320(std::monostate);
...
std::monostate x7440(std::monostate);
...
Num x7582 = x7580.i32_ne(x7578);
Stack.push(x7582);
bool x7583 = allConcrete(x7581, x7579);
SymVal x7584 = x7583 ? Concrete(x7582, 32) : x7581.neq(x7579).bool2bv();
SymStack.push(x7584);
}
...
SymVal x7610 = x7609.makeI32Symbol();
Stack.push(SymEnv.read(x7610));
SymStack.push(x7610);
}
{
Num x7611 = Stack.pop();
...
Num x7615 = x7613.i32_ne(x7611);
Stack.push(x7615);
bool x7616 = allConcrete(x7614, x7612);
SymVal x7617 = x7616 ? Concrete(x7615, 32) : x7614.neq(x7612).bool2bv();
SymStack.push(x7617);
}
Stack.push(I32V(1024));
SymStack.push(Concrete(I32V(1024), 32));
...
Num x7626 = x7624.i32_gt_s(x7622);
Stack.push(x7626);
bool x7627 = allConcrete(x7625, x7623);
SymVal x7628 = x7627 ? Concrete(x7626, 32) : x7625.gt(x7623).bool2bv();
SymStack.push(x7628);
}
Stack.push(I32V(1026));
SymStack.push(Concrete(I32V(1026), 32));
...
Num x7637 = x7635.i32_gt_s(x7633);
Stack.push(x7637);
bool x7638 = allConcrete(x7636, x7634);
SymVal x7639 = x7638 ? Concrete(x7637, 32) : x7636.gt(x7634).bool2bv();
SymStack.push(x7639);
}
Stack.push(I32V(1028));
SymStack.push(Concrete(I32V(1028), 32));
...
SymVal x7643 = x7642.makeI32Symbol();
Stack.push(SymEnv.read(x7643));
SymStack.push(x7643);
}
{
Num x7644 = Stack.pop();
...
Num x7648 = x7646.i32_gt_s(x7644);
Stack.push(x7648);
bool x7649 = allConcrete(x7647, x7645);
SymVal x7650 = x7649 ? Concrete(x7648, 32) : x7647.gt(x7645).bool2bv();
SymStack.push(x7650);
}
{
Num x7651 = Stack.pop();
...
Num x7655 = x7653.i32_and(x7651);
Stack.push(x7655);
bool x7656 = allConcrete(x7654, x7652);
SymVal x7657 = x7656 ? Concrete(x7655, 32) : x7654.bitwise_and(x7652);
SymStack.push(x7657);
}
{
Num x7658 = Stack.pop();
...
Num x7662 = x7660.i32_and(x7658);
Stack.push(x7662);
bool x7663 = allConcrete(x7661, x7659);
SymVal x7664 = x7663 ? Concrete(x7662, 32) : x7661.bitwise_and(x7659);
SymStack.push(x7664);
}
{
Num x7665 = Stack.pop();
...
Num x7669 = x7667.i32_and(x7665);
Stack.push(x7669);
bool x7670 = allConcrete(x7668, x7666);
SymVal x7671 = x7670 ? Concrete(x7669, 32) : x7668.bitwise_and(x7666);
SymStack.push(x7671);
}
{
Num x7672 = Stack.pop();
...
Num x7676 = x7674.i32_and(x7672);
Stack.push(x7676);
bool x7677 = allConcrete(x7675, x7673);
SymVal x7678 = x7677 ? Concrete(x7676, 32) : x7675.bitwise_and(x7673);
SymStack.push(x7678);
}
{
Num x7679 = Stack.pop();
...
Num x7683 = x7681.i32_and(x7679);
Stack.push(x7683);
bool x7684 = allConcrete(x7682, x7680);
SymVal x7685 = x7684 ? Concrete(x7683, 32) : x7682.bitwise_and(x7680);
SymStack.push(x7685);
}
{
Num x7686 = Stack.pop();
...
Num x7690 = x7688.i32_and(x7686);
Stack.push(x7690);
bool x7691 = allConcrete(x7689, x7687);
SymVal x7692 = x7691 ? Concrete(x7690, 32) : x7689.bitwise_and(x7687);
SymStack.push(x7692);
}
{
Num x7693 = Stack.pop();
...
Num x7697 = x7695.i32_and(x7693);
Stack.push(x7697);
bool x7698 = allConcrete(x7696, x7694);
SymVal x7699 = x7698 ? Concrete(x7697, 32) : x7696.bitwise_and(x7694);
SymStack.push(x7699);
}
{
Num x7700 = Stack.pop();
...
Num x7704 = x7702.i32_and(x7700);
Stack.push(x7704);
bool x7705 = allConcrete(x7703, x7701);
SymVal x7706 = x7705 ? Concrete(x7704, 32) : x7703.bitwise_and(x7701);
SymStack.push(x7706);
}
...
Num x7715 = x7713.i32_ne(x7711);
Stack.push(x7715);
bool x7716 = allConcrete(x7714, x7712);
SymVal x7717 = x7716 ? Concrete(x7715, 32) : x7714.neq(x7712).bool2bv();
SymStack.push(x7717);
}
Stack.push(I32V(1032));
SymStack.push(Concrete(I32V(1032), 32));
...
Num x7726 = x7724.i32_ne(x7722);
Stack.push(x7726);
bool x7727 = allConcrete(x7725, x7723);
SymVal x7728 = x7727 ? Concrete(x7726, 32) : x7725.neq(x7723).bool2bv();
SymStack.push(x7728);
}
Stack.push(I32V(1032));
SymStack.push(Concrete(I32V(1032), 32));
...
SymVal x7730 = x7729.makeI32Symbol();
Stack.push(SymEnv.read(x7730));
SymStack.push(x7730);
}
Stack.push(I32V(1028));
SymStack.push(Concrete(I32V(1028), 32));
...
Num x7737 = x7735.i32_ne(x7733);
Stack.push(x7737);
bool x7738 = allConcrete(x7736, x7734);
SymVal x7739 = x7738 ? Concrete(x7737, 32) : x7736.neq(x7734).bool2bv();
SymStack.push(x7739);
}
Stack.push(I32V(1032));
SymStack.push(Concrete(I32V(1032), 32));
...
ExploreTree.fillIfElseNode(x7780, 1);
}
int x7781 = x7779.toInt();
if (x7781 != 0) {
...
ExploreTree.moveCursor(false, makeControl(x7542, CURRENT_MCONT));
...
Num x7491 = x7489.i32_ne(x7487);
Stack.push(x7491);
bool x7492 = allConcrete(x7490, x7488);
SymVal x7493 = x7492 ? Concrete(x7491, 32) : x7490.neq(x7488).bool2bv();
SymStack.push(x7493);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
...
Num x7476 = x7474.i32_ne(x7472);
Stack.push(x7476);
bool x7477 = allConcrete(x7475, x7473);
SymVal x7478 = x7477 ? Concrete(x7476, 32) : x7475.neq(x7473).bool2bv();
SymStack.push(x7478);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
...
Num x7461 = x7459.i32_ne(x7457);
Stack.push(x7461);
bool x7462 = allConcrete(x7460, x7458);
SymVal x7463 = x7462 ? Concrete(x7461, 32) : x7460.neq(x7458).bool2bv();
SymStack.push(x7463);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
...
updateCurrentMCont(prependCont(x7440, CURRENT_MCONT));
}
__attribute__((musttail)) return x1678(std::monostate{});
return std::monostate{};
}
std::monostate x7440(std::monostate x7441) {
infoWhen("CALL", "Returning from the function at 8, stackSize =", Stack.size());
Frames.popFrameCaller(2);
SymFrames.popFrameCaller(2);
Stack.push(I32V(-1));
...
Num x7401 = x7399.i32_ne(x7397);
Stack.push(x7401);
bool x7402 = allConcrete(x7400, x7398);
SymVal x7403 = x7402 ? Concrete(x7401, 32) : x7400.neq(x7398).bool2bv();
SymStack.push(x7403);
}
{
Num x7404 = Stack.pop();
...
Num x7408 = x7406.i32_and(x7404);
Stack.push(x7408);
bool x7409 = allConcrete(x7407, x7405);
SymVal x7410 = x7409 ? Concrete(x7408, 32) : x7407.bitwise_and(x7405);
SymStack.push(x7410);
}
{
Num x7411 = Stack.pop();
...
Num x7415 = x7413.i32_and(x7411);
Stack.push(x7415);
bool x7416 = allConcrete(x7414, x7412);
SymVal x7417 = x7416 ? Concrete(x7415, 32) : x7414.bitwise_and(x7412);
SymStack.push(x7417);
}
{
Num x7418 = Stack.pop();
...
Num x7422 = x7420.i32_and(x7418);
Stack.push(x7422);
bool x7423 = allConcrete(x7421, x7419);
SymVal x7424 = x7423 ? Concrete(x7422, 32) : x7421.bitwise_and(x7419);
SymStack.push(x7424);
}
{
Num x7425 = Stack.pop();
...
Num x7429 = x7427.i32_and(x7425);
Stack.push(x7429);
bool x7430 = allConcrete(x7428, x7426);
SymVal x7431 = x7430 ? Concrete(x7429, 32) : x7428.bitwise_and(x7426);
SymStack.push(x7431);
}
{
Num x7432 = Stack.pop();
SymVal x7433 = SymStack.pop();
GENSYM_SYM_ASSERT(x7433);
GENSYM_ASSERT(x7432.toInt() != 0);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
Stack.push(I32V(1024));
...
SymVal x7435 = x7434.makeI32Symbol();
Stack.push(SymEnv.read(x7435));
SymStack.push(x7435);
}
{
...
Num x7376 = x7374.i32_eq(x7372);
Stack.push(x7376);
bool x7377 = allConcrete(x7375, x7373);
SymVal x7378 = x7377 ? Concrete(x7376, 32) : x7375.eq(x7373).bool2bv();
SymStack.push(x7378);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
...
Num x7351 = x7349.i32_eq(x7347);
Stack.push(x7351);
bool x7352 = allConcrete(x7350, x7348);
SymVal x7353 = x7352 ? Concrete(x7351, 32) : x7350.eq(x7348).bool2bv();
SymStack.push(x7353);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
...
SymVal x7340 = x7339.makeI32Symbol();
Stack.push(SymEnv.read(x7340));
SymStack.push(x7340);
}
{
infoWhen("CALL", "Taking arguments from stack to call function at ", 8);
...
Frames.set(0, x7342);
Frames.set(1, x7341);
SymFrames.set(0, x7344);
SymFrames.set(1, x7343);
updateCurrentMCont(prependCont(x7320, CURRENT_MCONT));
}
__attribute__((musttail)) return x1678(std::monostate{});
return std::monostate{};
}
std::monostate x7320(std::monostate x7321) {
infoWhen("CALL", "Returning from the function at 8, stackSize =", Stack.size());
Frames.popFrameCaller(2);
SymFrames.popFrameCaller(2);
Stack.push(I32V(-1));
...
Num x7326 = x7324.i32_eq(x7322);
Stack.push(x7326);
bool x7327 = allConcrete(x7325, x7323);
SymVal x7328 = x7327 ? Concrete(x7326, 32) : x7325.eq(x7323).bool2bv();
SymStack.push(x7328);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
...
SymVal x7315 = x7314.makeI32Symbol();
Stack.push(SymEnv.read(x7315));
SymStack.push(x7315);
}
{
infoWhen("CALL", "Taking arguments from stack to call function at ", 8);
...
Frames.set(0, x7317);
Frames.set(1, x7316);
SymFrames.set(0, x7319);
SymFrames.set(1, x7318);
...
GENSYM_SYM_ASSERT(x7309);
GENSYM_ASSERT(x7308.toInt() != 0);
}
