...
std::monostate x7330(std::monostate);
...
Num x7389 = x7387.i32_ne(x7385);
Stack.push(x7389);
bool x7390 = allConcrete(x7388, x7386);
SymVal x7391 = x7390 ? Concrete(x7389, 32) : x7388.neq(x7386).bool2bv();
SymStack.push(x7391);
}
Stack.push(I32V(1024));
SymStack.push(Concrete(I32V(1024), 32));
...
Num x7400 = x7398.i32_gt_s(x7396);
Stack.push(x7400);
bool x7401 = allConcrete(x7399, x7397);
SymVal x7402 = x7401 ? Concrete(x7400, 32) : x7399.gt(x7397).bool2bv();
SymStack.push(x7402);
}
{
Num x7403 = Stack.pop();
...
Num x7407 = x7405.i32_and(x7403);
Stack.push(x7407);
bool x7408 = allConcrete(x7406, x7404);
SymVal x7409 = x7408 ? Concrete(x7407, 32) : x7406.bitwise_and(x7404);
SymStack.push(x7409);
}
...
Num x7418 = x7416.i32_ne(x7414);
Stack.push(x7418);
bool x7419 = allConcrete(x7417, x7415);
SymVal x7420 = x7419 ? Concrete(x7418, 32) : x7417.neq(x7415).bool2bv();
SymStack.push(x7420);
}
Stack.push(I32V(1028));
SymStack.push(Concrete(I32V(1028), 32));
...
Num x7429 = x7427.i32_ne(x7425);
Stack.push(x7429);
bool x7430 = allConcrete(x7428, x7426);
SymVal x7431 = x7430 ? Concrete(x7429, 32) : x7428.neq(x7426).bool2bv();
SymStack.push(x7431);
}
{
Num x7432 = Stack.pop();
...
Num x7436 = x7434.i32_and(x7432);
Stack.push(x7436);
bool x7437 = allConcrete(x7435, x7433);
SymVal x7438 = x7437 ? Concrete(x7436, 32) : x7435.bitwise_and(x7433);
SymStack.push(x7438);
}
{
Num x7439 = Stack.pop();
...
Num x7443 = x7441.i32_and(x7439);
Stack.push(x7443);
bool x7444 = allConcrete(x7442, x7440);
SymVal x7445 = x7444 ? Concrete(x7443, 32) : x7442.bitwise_and(x7440);
SymStack.push(x7445);
}
Num x7446 = Stack.pop();
{
SymVal x7447 = SymStack.pop();
ExploreTree.fillIfElseNode(x7447, 1);
}
int x7448 = x7446.toInt();
if (x7448 != 0) {
...
ExploreTree.moveCursor(false, makeControl(x7371, CURRENT_MCONT));
...
updateCurrentMCont(prependCont(x7330, CURRENT_MCONT));
}
__attribute__((musttail)) return x1666(std::monostate{});
return std::monostate{};
}
std::monostate x7330(std::monostate x7331) {
...
Num x7336 = x7334.i32_ne(x7332);
Stack.push(x7336);
bool x7337 = allConcrete(x7335, x7333);
SymVal x7338 = x7337 ? Concrete(x7336, 32) : x7335.neq(x7333).bool2bv();
SymStack.push(x7338);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
...
Num x7321 = x7319.i32_ne(x7317);
Stack.push(x7321);
bool x7322 = allConcrete(x7320, x7318);
SymVal x7323 = x7322 ? Concrete(x7321, 32) : x7320.neq(x7318).bool2bv();
SymStack.push(x7323);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
...
SymVal x7325 = x7324.makeI32Symbol();
Stack.push(SymEnv.read(x7325));
SymStack.push(x7325);
}
{
infoWhen("CALL", "Taking arguments from stack to call function at ", 8);
...
Frames.set(0, x7327);
Frames.set(1, x7326);
SymFrames.set(0, x7329);
SymFrames.set(1, x7328);
...
Num x7292 = x7290.i32_ne(x7288);
Stack.push(x7292);
bool x7293 = allConcrete(x7291, x7289);
SymVal x7294 = x7293 ? Concrete(x7292, 32) : x7291.neq(x7289).bool2bv();
SymStack.push(x7294);
}
{
Num x7295 = Stack.pop();
...
Num x7299 = x7297.i32_and(x7295);
Stack.push(x7299);
bool x7300 = allConcrete(x7298, x7296);
SymVal x7301 = x7300 ? Concrete(x7299, 32) : x7298.bitwise_and(x7296);
SymStack.push(x7301);
}
{
Num x7302 = Stack.pop();
...
Num x7306 = x7304.i32_and(x7302);
Stack.push(x7306);
bool x7307 = allConcrete(x7305, x7303);
SymVal x7308 = x7307 ? Concrete(x7306, 32) : x7305.bitwise_and(x7303);
SymStack.push(x7308);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
