...
std::monostate x7415(std::monostate);
...
Num x7441 = x7439.i32_ne(x7437);
Stack.push(x7441);
bool x7442 = allConcrete(x7440, x7438);
SymVal x7443 = x7442 ? Concrete(x7441, 32) : x7440.neq(x7438).bool2bv();
SymStack.push(x7443);
}
Stack.push(I32V(1024));
SymStack.push(Concrete(I32V(1024), 32));
...
Num x7452 = x7450.i32_gt_s(x7448);
Stack.push(x7452);
bool x7453 = allConcrete(x7451, x7449);
SymVal x7454 = x7453 ? Concrete(x7452, 32) : x7451.gt(x7449).bool2bv();
SymStack.push(x7454);
}
{
Num x7455 = Stack.pop();
...
Num x7470 = x7468.i32_ne(x7466);
Stack.push(x7470);
bool x7471 = allConcrete(x7469, x7467);
SymVal x7472 = x7471 ? Concrete(x7470, 32) : x7469.neq(x7467).bool2bv();
SymStack.push(x7472);
}
Stack.push(I32V(1028));
SymStack.push(Concrete(I32V(1028), 32));
...
Num x7481 = x7479.i32_ne(x7477);
Stack.push(x7481);
bool x7482 = allConcrete(x7480, x7478);
SymVal x7483 = x7482 ? Concrete(x7481, 32) : x7480.neq(x7478).bool2bv();
SymStack.push(x7483);
}
{
Num x7484 = Stack.pop();
...
Num x7488 = x7486.i32_and(x7484);
Stack.push(x7488);
bool x7489 = allConcrete(x7487, x7485);
SymVal x7490 = x7489 ? Concrete(x7488, 32) : x7487.bitwise_and(x7485);
SymStack.push(x7490);
}
{
Num x7491 = Stack.pop();
...
Num x7495 = x7493.i32_and(x7491);
Stack.push(x7495);
bool x7496 = allConcrete(x7494, x7492);
SymVal x7497 = x7496 ? Concrete(x7495, 32) : x7494.bitwise_and(x7492);
SymStack.push(x7497);
}
Num x7498 = Stack.pop();
{
SymVal x7499 = SymStack.pop();
ExploreTree.fillIfElseNode(x7499, 1);
}
int x7500 = x7498.toInt();
if (x7500 != 0) {
...
updateCurrentMCont(prependCont(x7415, CURRENT_MCONT));
}
__attribute__((musttail)) return x1593(std::monostate{});
} else {
ExploreTree.moveCursor(false, makeControl(x7423, CURRENT_MCONT));
...
std::monostate x7415(std::monostate x7416) {
...
Num x7388 = x7386.i32_ne(x7384);
Stack.push(x7388);
bool x7389 = allConcrete(x7387, x7385);
SymVal x7390 = x7389 ? Concrete(x7388, 32) : x7387.neq(x7385).bool2bv();
SymStack.push(x7390);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
...
Num x7373 = x7371.i32_ne(x7369);
Stack.push(x7373);
bool x7374 = allConcrete(x7372, x7370);
SymVal x7375 = x7374 ? Concrete(x7373, 32) : x7372.neq(x7370).bool2bv();
SymStack.push(x7375);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
...
Num x7344 = x7342.i32_ne(x7340);
Stack.push(x7344);
bool x7345 = allConcrete(x7343, x7341);
SymVal x7346 = x7345 ? Concrete(x7344, 32) : x7343.neq(x7341).bool2bv();
SymStack.push(x7346);
}
{
Num x7347 = Stack.pop();
...
Num x7351 = x7349.i32_and(x7347);
Stack.push(x7351);
bool x7352 = allConcrete(x7350, x7348);
SymVal x7353 = x7352 ? Concrete(x7351, 32) : x7350.bitwise_and(x7348);
SymStack.push(x7353);
}
{
Num x7354 = Stack.pop();
...
Num x7358 = x7356.i32_and(x7354);
Stack.push(x7358);
bool x7359 = allConcrete(x7357, x7355);
SymVal x7360 = x7359 ? Concrete(x7358, 32) : x7357.bitwise_and(x7355);
SymStack.push(x7360);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
...
Num x17 = Stack.pop();
SymStack.pop();
memoryInitialize(x17.toInt(), "a\x00b\x00h\x00");
return std::monostate{};
}
