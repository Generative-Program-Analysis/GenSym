...
std::monostate x7268(std::monostate);
std::monostate x7283(std::monostate);
std::monostate x7293(std::monostate);
std::monostate x7308(std::monostate);
std::monostate x7318(std::monostate);
std::monostate x7333(std::monostate);
...
SymVal x7523 = x7522.makeI32Symbol();
Stack.push(SymEnv.read(x7523));
SymStack.push(x7523);
}
Stack.push(I32V(1026));
SymStack.push(Concrete(I32V(1026), 32));
...
Num x7541 = x7539.i32_gt_s(x7537);
Stack.push(x7541);
bool x7542 = allConcrete(x7540, x7538);
SymVal x7543 = x7542 ? Concrete(x7541, 32) : x7540.gt(x7538).bool2bv();
SymStack.push(x7543);
}
Stack.push(I32V(1026));
SymStack.push(Concrete(I32V(1026), 32));
...
Num x7552 = x7550.i32_gt_s(x7548);
Stack.push(x7552);
bool x7553 = allConcrete(x7551, x7549);
SymVal x7554 = x7553 ? Concrete(x7552, 32) : x7551.gt(x7549).bool2bv();
SymStack.push(x7554);
}
{
Num x7555 = Stack.pop();
...
Num x7559 = x7557.i32_and(x7555);
Stack.push(x7559);
bool x7560 = allConcrete(x7558, x7556);
SymVal x7561 = x7560 ? Concrete(x7559, 32) : x7558.bitwise_and(x7556);
SymStack.push(x7561);
}
{
Num x7562 = Stack.pop();
...
Num x7566 = x7564.i32_and(x7562);
Stack.push(x7566);
bool x7567 = allConcrete(x7565, x7563);
SymVal x7568 = x7567 ? Concrete(x7566, 32) : x7565.bitwise_and(x7563);
SymStack.push(x7568);
}
{
Num x7569 = Stack.pop();
...
Num x7573 = x7571.i32_and(x7569);
Stack.push(x7573);
bool x7574 = allConcrete(x7572, x7570);
SymVal x7575 = x7574 ? Concrete(x7573, 32) : x7572.bitwise_and(x7570);
SymStack.push(x7575);
}
{
Num x7576 = Stack.pop();
...
Num x7591 = x7589.i32_ne(x7587);
Stack.push(x7591);
bool x7592 = allConcrete(x7590, x7588);
SymVal x7593 = x7592 ? Concrete(x7591, 32) : x7590.neq(x7588).bool2bv();
SymStack.push(x7593);
}
Stack.push(I32V(1030));
SymStack.push(Concrete(I32V(1030), 32));
...
Num x7613 = x7611.i32_ne(x7609);
Stack.push(x7613);
bool x7614 = allConcrete(x7612, x7610);
SymVal x7615 = x7614 ? Concrete(x7613, 32) : x7612.neq(x7610).bool2bv();
SymStack.push(x7615);
}
...
SymVal x7619 = x7618.makeI32Symbol();
Stack.push(SymEnv.read(x7619));
SymStack.push(x7619);
}
{
Num x7620 = Stack.pop();
...
Num x7624 = x7622.i32_ne(x7620);
Stack.push(x7624);
bool x7625 = allConcrete(x7623, x7621);
SymVal x7626 = x7625 ? Concrete(x7624, 32) : x7623.neq(x7621).bool2bv();
SymStack.push(x7626);
}
Stack.push(I32V(1032));
SymStack.push(Concrete(I32V(1032), 32));
...
Num x7635 = x7633.i32_ne(x7631);
Stack.push(x7635);
bool x7636 = allConcrete(x7634, x7632);
SymVal x7637 = x7636 ? Concrete(x7635, 32) : x7634.neq(x7632).bool2bv();
SymStack.push(x7637);
}
Stack.push(I32V(1032));
SymStack.push(Concrete(I32V(1032), 32));
...
Num x7646 = x7644.i32_ne(x7642);
Stack.push(x7646);
bool x7647 = allConcrete(x7645, x7643);
SymVal x7648 = x7647 ? Concrete(x7646, 32) : x7645.neq(x7643).bool2bv();
SymStack.push(x7648);
}
Stack.push(I32V(1032));
SymStack.push(Concrete(I32V(1032), 32));
...
SymVal x7652 = x7651.makeI32Symbol();
Stack.push(SymEnv.read(x7652));
SymStack.push(x7652);
}
{
Num x7653 = Stack.pop();
...
ExploreTree.fillIfElseNode(x7710, 1);
}
int x7711 = x7709.toInt();
if (x7711 != 0) {
...
ExploreTree.moveCursor(false, makeControl(x7490, CURRENT_MCONT));
ExploreTree.fillNotToExploredNode();
}
return std::monostate{};
}
std::monostate x7490(std::monostate x7491) {
...
updateCurrentMCont(prependCont(x7458, CURRENT_MCONT));
}
__attribute__((musttail)) return x1581(std::monostate{});
return std::monostate{};
}
std::monostate x7458(std::monostate x7459) {
infoWhen("CALL", "Returning from the function at 11, stackSize =", Stack.size());
Frames.popFrameCaller(1);
SymFrames.popFrameCaller(1);
{
...
SymVal x7453 = x7452.makeI32Symbol();
Stack.push(SymEnv.read(x7453));
SymStack.push(x7453);
}
{
...
Frames.set(0, x7455);
Frames.set(1, x7454);
SymFrames.set(0, x7457);
SymFrames.set(1, x7456);
updateCurrentMCont(prependCont(x7433, CURRENT_MCONT));
}
__attribute__((musttail)) return x1666(std::monostate{});
return std::monostate{};
}
std::monostate x7433(std::monostate x7434) {
...
Num x7439 = x7437.i32_ne(x7435);
Stack.push(x7439);
bool x7440 = allConcrete(x7438, x7436);
SymVal x7441 = x7440 ? Concrete(x7439, 32) : x7438.neq(x7436).bool2bv();
SymStack.push(x7441);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
...
Num x7424 = x7422.i32_ne(x7420);
Stack.push(x7424);
bool x7425 = allConcrete(x7423, x7421);
SymVal x7426 = x7425 ? Concrete(x7424, 32) : x7423.neq(x7421).bool2bv();
SymStack.push(x7426);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
...
SymVal x7428 = x7427.makeI32Symbol();
Stack.push(SymEnv.read(x7428));
SymStack.push(x7428);
}
{
infoWhen("CALL", "Taking arguments from stack to call function at ", 8);
...
Num x7409 = x7407.i32_ne(x7405);
Stack.push(x7409);
bool x7410 = allConcrete(x7408, x7406);
SymVal x7411 = x7410 ? Concrete(x7409, 32) : x7408.neq(x7406).bool2bv();
SymStack.push(x7411);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
...
Num x7394 = x7392.i32_ne(x7390);
Stack.push(x7394);
bool x7395 = allConcrete(x7393, x7391);
SymVal x7396 = x7395 ? Concrete(x7394, 32) : x7393.neq(x7391).bool2bv();
SymStack.push(x7396);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
...
Num x7349 = x7347.i32_ne(x7345);
Stack.push(x7349);
bool x7350 = allConcrete(x7348, x7346);
SymVal x7351 = x7350 ? Concrete(x7349, 32) : x7348.neq(x7346).bool2bv();
SymStack.push(x7351);
}
{
Num x7352 = Stack.pop();
...
Num x7356 = x7354.i32_and(x7352);
Stack.push(x7356);
bool x7357 = allConcrete(x7355, x7353);
SymVal x7358 = x7357 ? Concrete(x7356, 32) : x7355.bitwise_and(x7353);
SymStack.push(x7358);
}
{
Num x7359 = Stack.pop();
...
Num x7363 = x7361.i32_and(x7359);
Stack.push(x7363);
bool x7364 = allConcrete(x7362, x7360);
SymVal x7365 = x7364 ? Concrete(x7363, 32) : x7362.bitwise_and(x7360);
SymStack.push(x7365);
}
{
Num x7366 = Stack.pop();
...
Num x7370 = x7368.i32_and(x7366);
Stack.push(x7370);
bool x7371 = allConcrete(x7369, x7367);
SymVal x7372 = x7371 ? Concrete(x7370, 32) : x7369.bitwise_and(x7367);
SymStack.push(x7372);
}
{
Num x7373 = Stack.pop();
...
Num x7377 = x7375.i32_and(x7373);
Stack.push(x7377);
bool x7378 = allConcrete(x7376, x7374);
SymVal x7379 = x7378 ? Concrete(x7377, 32) : x7376.bitwise_and(x7374);
SymStack.push(x7379);
}
{
Num x7380 = Stack.pop();
SymVal x7381 = SymStack.pop();
GENSYM_SYM_ASSERT(x7381);
GENSYM_ASSERT(x7380.toInt() != 0);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
Stack.push(I32V(1024));
...
updateCurrentMCont(prependCont(x7333, CURRENT_MCONT));
}
__attribute__((musttail)) return x1996(std::monostate{});
return std::monostate{};
}
std::monostate x7333(std::monostate x7334) {
...
Num x7324 = x7322.i32_eq(x7320);
Stack.push(x7324);
bool x7325 = allConcrete(x7323, x7321);
SymVal x7326 = x7325 ? Concrete(x7324, 32) : x7323.eq(x7321).bool2bv();
SymStack.push(x7326);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
...
SymVal x7328 = x7327.makeI32Symbol();
Stack.push(SymEnv.read(x7328));
SymStack.push(x7328);
}
{
infoWhen("CALL", "Taking arguments from stack to call function at ", 12);
...
SymFrames.set(1, x7331);
updateCurrentMCont(prependCont(x7308, CURRENT_MCONT));
}
__attribute__((musttail)) return x1996(std::monostate{});
return std::monostate{};
}
std::monostate x7308(std::monostate x7309) {
infoWhen("CALL", "Returning from the function at 12, stackSize =", Stack.size());
Frames.popFrameCaller(2);
SymFrames.popFrameCaller(2);
{
...
Num x7299 = x7297.i32_eq(x7295);
Stack.push(x7299);
bool x7300 = allConcrete(x7298, x7296);
SymVal x7301 = x7300 ? Concrete(x7299, 32) : x7298.eq(x7296).bool2bv();
SymStack.push(x7301);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
...
SymVal x7303 = x7302.makeI32Symbol();
Stack.push(SymEnv.read(x7303));
SymStack.push(x7303);
}
{
infoWhen("CALL", "Taking arguments from stack to call function at ", 12);
...
SymFrames.set(1, x7306);
updateCurrentMCont(prependCont(x7283, CURRENT_MCONT));
}
__attribute__((musttail)) return x1996(std::monostate{});
return std::monostate{};
}
std::monostate x7283(std::monostate x7284) {
infoWhen("CALL", "Returning from the function at 12, stackSize =", Stack.size());
Frames.popFrameCaller(2);
SymFrames.popFrameCaller(2);
{
Num x7285 = Stack.pop();
SymVal x7286 = SymStack.pop();
Frames.set(0, x7285);
SymFrames.set(0, x7286);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
Stack.push(I32V(1028));
...
SymVal x7288 = x7287.makeI32Symbol();
Stack.push(SymEnv.read(x7288));
SymStack.push(x7288);
}
{
infoWhen("CALL", "Taking arguments from stack to call function at ", 8);
...
Frames.set(0, x7290);
Frames.set(1, x7289);
SymFrames.set(0, x7292);
SymFrames.set(1, x7291);
updateCurrentMCont(prependCont(x7268, CURRENT_MCONT));
}
__attribute__((musttail)) return x1666(std::monostate{});
return std::monostate{};
}
std::monostate x7268(std::monostate x7269) {
infoWhen("CALL", "Returning from the function at 8, stackSize =", Stack.size());
Frames.popFrameCaller(2);
SymFrames.popFrameCaller(2);
Stack.push(I32V(-1));
...
Num x7274 = x7272.i32_eq(x7270);
Stack.push(x7274);
bool x7275 = allConcrete(x7273, x7271);
SymVal x7276 = x7275 ? Concrete(x7274, 32) : x7273.eq(x7271).bool2bv();
SymStack.push(x7276);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
...
{
Stack.pop();
SymVal x7277 = SymStack.pop();
SymVal x7278 = x7277.makeI32Symbol();
Stack.push(SymEnv.read(x7278));
SymStack.push(x7278);
}
{
infoWhen("CALL", "Taking arguments from stack to call function at ", 12);
...
SymFrames.set(1, x7281);
updateCurrentMCont(prependCont(x7258, CURRENT_MCONT));
}
__attribute__((musttail)) return x1996(std::monostate{});
return std::monostate{};
}
...
{
Num x7260 = Stack.pop();
SymVal x7261 = SymStack.pop();
Frames.set(0, x7260);
SymFrames.set(0, x7261);
}
Stack.push(Frames.get(0));
SymStack.push(SymFrames.get(0));
Stack.push(I32V(1030));
...
{
Stack.pop();
SymVal x7262 = SymStack.pop();
SymVal x7263 = x7262.makeI32Symbol();
Stack.push(SymEnv.read(x7263));
SymStack.push(x7263);
}
{
infoWhen("CALL", "Taking arguments from stack to call function at ", 8);
...
Frames.set(0, x7265);
Frames.set(1, x7264);
SymFrames.set(0, x7267);
SymFrames.set(1, x7266);
...
GENSYM_SYM_ASSERT(x7257);
GENSYM_ASSERT(x7256.toInt() != 0);
}
