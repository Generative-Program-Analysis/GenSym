...
# Usage: python compile.py [extra clang++ flags...]
...
BASE_FLAGS = [
    ...
    "-Wextra",
    "-DUSE_IMM",
    f"-I{HERE.parent.parent / 'headers'}",
    "-lz3",
...
def compile_all(cpp_files=None, flags=None):
    ...
    for cpp in cpp_files:
        ...
        cmd = ["clang++", str(cpp), "-o", str(out)] + flags
        ...
        snapshot_cmd = ["clang++", str(cpp), "-o", str(snapshot_out)] + SNAPSHOT_FLAGS
        ...
        snapshot_cost_model_cmd = ["clang++", str(cpp), "-o", str(snapshot_cost_model_out)] + SNAPSHOT_COST_MODEL_FLAGS
