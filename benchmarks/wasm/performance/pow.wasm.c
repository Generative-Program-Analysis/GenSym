...
static u32 w2c_pow_power_0(w2c_pow*, u32, u32);
static u32 w2c_pow_real_main_0(w2c_pow*);

FUNC_TYPE_T(w2c_pow_t0) = "\x92\xfb\x6a\xdf\x49\x07\x0a\x83\xbe\x08\x02\x68\xcd\xf6\x95\x27\x4a\xc2\xf3\xe5\xe4\x7d\x29\x49\xe8\xed\x42\x92\x6a\x9d\xda\xf0";
FUNC_TYPE_T(w2c_pow_t1) = "\x72\xab\x00\xdf\x20\x3d\xce\xa1\xf2\x29\xc7\x9d\x13\x40\x7e\x98\xac\x7d\x41\x4a\x53\x2e\x42\x42\x61\x55\x2e\xaa\xeb\xbe\xc6\x35";

static void init_globals(w2c_pow* instance) {
  instance->w2c_g0 = 1048576u;
  instance->w2c_0x5F_data_end = 1048576u;
  instance->w2c_0x5F_heap_base = 1048576u;
}

static void init_memories(w2c_pow* instance) {
  wasm_rt_allocate_memory(&instance->w2c_memory, 16, 65536, 0, 65536);
}

static void init_tables(w2c_pow* instance) {
...
/* export: 'power' */
u32 w2c_pow_power(w2c_pow* instance, u32 var_p0, u32 var_p1) {
#if WASM_RT_USE_SEGUE_FOR_THIS_MODULE
#if !WASM_RT_SEGUE_FREE_SEGMENT
...
#endif
  u32 ret = w2c_pow_power_0(instance, var_p0, var_p1);
...
/* export: 'real_main' */
u32 w2c_pow_real_main(w2c_pow* instance) {
#if WASM_RT_USE_SEGUE_FOR_THIS_MODULE
#if !WASM_RT_SEGUE_FREE_SEGMENT
  void* segue_saved_base = wasm_rt_segue_read_base();
#endif
  wasm_rt_segue_write_base(instance->w2c_memory.data);
#endif
  u32 ret = w2c_pow_real_main_0(instance);
#if WASM_RT_USE_SEGUE_FOR_THIS_MODULE && !WASM_RT_SEGUE_FREE_SEGMENT
  wasm_rt_segue_write_base(segue_saved_base);
#endif
  return ret;
...
void wasm2c_pow_instantiate(w2c_pow* instance) {
...
void wasm2c_pow_free(w2c_pow* instance) {
...
u32 w2c_pow_power_0(w2c_pow* instance, u32 var_p0, u32 var_p1) {
  u32 var_l2 = 0;
  FUNC_PROLOGUE;
  u32 var_i0, var_i1;
  var_i0 = 1u;
...
u32 w2c_pow_real_main_0(w2c_pow* instance) {
  ...
  var_L0:
    var_i0 = 2u;
    var_i1 = 20u;
    var_i0 = w2c_pow_power_0(instance, var_i0, var_i1);
    // printf("pow(%u, %u) = %u\n", 2u, 20u, var_i0);
    var_l1 = var_i0;
    var_i0 = var_l0;
    var_i1 = 1u;
