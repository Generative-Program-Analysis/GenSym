...
static u32 w2c_ack_ack_0(w2c_ack*, u32, u32);
static void w2c_ack_real_main_0(w2c_ack*);

FUNC_TYPE_T(w2c_ack_t0) = "\x92\xfb\x6a\xdf\x49\x07\x0a\x83\xbe\x08\x02\x68\xcd\xf6\x95\x27\x4a\xc2\xf3\xe5\xe4\x7d\x29\x49\xe8\xed\x42\x92\x6a\x9d\xda\xf0";
FUNC_TYPE_T(w2c_ack_t1) = "\x36\xa9\xe7\xf1\xc9\x5b\x82\xff\xb9\x97\x43\xe0\xc5\xc4\xce\x95\xd8\x3c\x9a\x43\x0a\xac\x59\xf8\x4e\xf3\xcb\xfa\xb6\x14\x50\x68";

static void init_globals(w2c_ack* instance) {
  instance->w2c_g0 = 1048576u;
  instance->w2c_0x5F_data_end = 1048576u;
  instance->w2c_0x5F_heap_base = 1048576u;
}

static void init_memories(w2c_ack* instance) {
  wasm_rt_allocate_memory(&instance->w2c_memory, 16, 65536, 0, 65536);
}

static void init_tables(w2c_ack* instance) {
  wasm_rt_allocate_funcref_table(&instance->w2c_T0, 1, 1);
}

/* export: 'memory' */
wasm_rt_memory_t* w2c_ack_memory(w2c_ack* instance) {
  return &instance->w2c_memory;
}

/* export: 'ack' */
u32 w2c_ack_ack(w2c_ack* instance, u32 var_p0, u32 var_p1) {
#if WASM_RT_USE_SEGUE_FOR_THIS_MODULE
#if !WASM_RT_SEGUE_FREE_SEGMENT
...
#endif
  u32 ret = w2c_ack_ack_0(instance, var_p0, var_p1);
...
/* export: 'real_main' */
void w2c_ack_real_main(w2c_ack* instance) {
#if WASM_RT_USE_SEGUE_FOR_THIS_MODULE
#if !WASM_RT_SEGUE_FREE_SEGMENT
  void* segue_saved_base = wasm_rt_segue_read_base();
#endif
...
/* export: '__data_end' */
u32* w2c_ack_0x5F_data_end(w2c_ack* instance) {
  return &instance->w2c_0x5F_data_end;
}

/* export: '__heap_base' */
u32* w2c_ack_0x5F_heap_base(w2c_ack* instance) {
  return &instance->w2c_0x5F_heap_base;
}

void wasm2c_ack_instantiate(w2c_ack* instance) {
...
void wasm2c_ack_free(w2c_ack* instance) {
  wasm_rt_free_funcref_table(&instance->w2c_T0);
  wasm_rt_free_memory(&instance->w2c_memory);
}

wasm_rt_func_type_t wasm2c_ack_get_func_type(uint32_t param_count, uint32_t result_count, ...) {
  va_list args;
...
u32 w2c_ack_ack_0(w2c_ack* instance, u32 var_p0, u32 var_p1) {
  FUNC_PROLOGUE;
  ...
  var_L1:
    ...
    var_i2 = 4294967295u;
    var_i1 += var_i2;
    var_i0 = w2c_ack_ack_0(instance, var_i0, var_i1);
    var_p1 = var_i0;
    var_B2:;
    var_i0 = var_p0;
    var_i1 = 4294967295u;
...
void w2c_ack_real_main_0(w2c_ack* instance) {
