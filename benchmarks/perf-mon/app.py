...
def main_handler():
    ...
    @H.register(check_suite__app__slug="llsc-bench", check_suite__head_branch="main", action="*requested")
    @H.register(check_run__app__slug="llsc-bench", action="rerequested")
    def create_new_run():
    ...
    @H.register(check_run__app__slug="llsc-bench", action="created")
    def initiate_run():
